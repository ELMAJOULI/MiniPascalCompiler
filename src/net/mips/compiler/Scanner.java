...
public class Scanner {
	...
	/*
	 * la méthode pour initialiser la table dynamique des mots clés
	 */
	...
	/*
	 * codageLex est la méthode qui permet de boucler dans 
	 * la table des mots clés pour associer pour chaque symbole lu 
	 * son token.
	...
	public void codageLex() {
	 ...
	 /*
	  * tester si le flux est pret pour lire un caractère du fichier
	  * d'entré
	  */
	...
	/*
	 * si le caractère lu respecte l'expression reguliere 
	 * 		mot ::= lettre{lettre|chiffre}*
	 * on utilise la méthod lireMot() qui embarque la procedure lireCar
	 * et codageLex
	 */
